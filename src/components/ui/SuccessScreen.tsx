...
export function SuccessScreen({ message, buttonText, onAction }: SuccessScreenProps) {
  return (
    <PageLayout centered>
      <div className="flex flex-col items-center gap-4 px-4" role="status">
        ...
        <button
          onClick={onAction}
          className="flex w-full py-3 justify-center items-center rounded-lg bg-primary active:scale-[0.97] transition-transform mt-2"
        >
