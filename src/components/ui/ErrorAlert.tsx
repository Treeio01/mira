...
export function ErrorAlert({ message }: ErrorAlertProps) {
  return (
    <div className="flex w-full items-center gap-2.5 bg-[#2A1520] border border-[#FF3B30]/20 rounded-lg px-3 py-2.5">
      ...
      <span className="text-[#FF6961] font-medium text-[13px] leading-[140%] tracking-[-0.02em]">
        {message}
      </span>
    </div>
  );
